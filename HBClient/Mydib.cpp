...
CMyDib::CMyDib(const char*szFilename, unsigned long dwFilePointer)
{
	...
	DWORD nCount;
	char PathName[28];
	wsprintfA( PathName, "sprites\\%s.pak", szFilename );
	hFileRead = CreateFileA(PathName, GENERIC_READ, NULL, NULL, OPEN_EXISTING, NULL, NULL);
