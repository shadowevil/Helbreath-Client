...
#define	UPDATE_SCREEN_ON_CREATE_NEW_ACCOUNT60	"수 없습니다. 잘못된 주민등록번호 입니다."
#define	UPDATE_SCREEN_ON_CREATE_NEW_ACCOUNT61	"올바른 주민등록번호를 please enter a character's name."
...
#define	DRAW_DIALOGBOX_LEVELUP_SETTING3	"* Points left: %d"
