...
public:
	...
	virtual ~CMapData();
	void Init();
	void OpenMapDataFile(const char* cFn);
	...
	BOOL __fastcall bSetDeadOwner(WORD wObjectID, short sX, short sY, short sType, char cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, short sStatus, const char* pName);
	...
	int  iObjectFrameCounter(const char* cPlayerName, short sViewPointX, short sViewPointY);
