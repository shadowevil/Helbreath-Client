...
void CMapData::OpenMapDataFile(const char* cFn)
{
	HANDLE hFileRead;
	DWORD  nCount;
	char cHeader[260];
...
int CMapData::iObjectFrameCounter(const char* cPlayerName, short sViewPointX, short sViewPointY)
{
 int dX,dY, sVal;
...
BOOL __fastcall CMapData::bSetDeadOwner(WORD wObjectID, short sX, short sY, short sType, char cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, short sStatus, const char* pName)
{
 int  dX, dY;
 char pTmpName[12];
