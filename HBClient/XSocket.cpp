...
BOOL XSocket::bBlockConnect(const char* pAddr, int iPort, unsigned int uiMsg)
{
 SOCKADDR_IN	 saTemp;
 int             iRet;
 DWORD			 dwOpt;
...
BOOL XSocket::bConnect(const char* pAddr, int iPort, unsigned int uiMsg)
{
 SOCKADDR_IN	 saTemp;
 u_long          arg;
 int             iRet;
...
int XSocket::_iSend_ForInternalUse(const char* cData, int iSize)
{
 int  iOutLen, iRet, WSAErr;
...
int XSocket::iSendMsg(const char* cData, DWORD dwSize, char cKey)
{
 WORD * wp;
 int    i, iRet;
...
BOOL XSocket::bListen(const char* pAddr, int iPort, unsigned int uiMsg)
{
 SOCKADDR_IN	 saTemp;
...
int XSocket::iSendMsgBlockingMode(const char*buf,int nbytes)
{
