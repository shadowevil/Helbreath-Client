	...
	case WM_ACTIVATEAPP:
		if( wParam == 0 ) {
			...
			if (G_pGame->bCheckImportantFile() == FALSE) {
				MessageBoxA(G_pGame->m_hWnd, "File checksum error! Get Update again please!", "ERROR1", MB_ICONEXCLAMATION | MB_OK);
				PostQuitMessage(0);
				return 0;
			}
		}
...
BOOL InitInstance( HINSTANCE hInstance, int nCmdShow )
{
	...
	G_hWnd = CreateWindowExA(NULL, szAppClass, "Helbreath Crusade", WS_POPUP, cx-320, cy-240, 
